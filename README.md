Before starting building my project, I have created a new database in MySQL Workbench named ecommerce_api, and installed dependencies initializing Flask App.
